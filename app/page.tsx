      ...
      <main className="max-w-6xl mx-auto p-6 mt-6 grid grid-cols-1 lg:grid-cols-12 gap-8 print:p-0 print:m-0 print:block">
        ...
        <div className="lg:col-span-4 bg-white p-6 rounded-lg shadow-sm border border-gray-200 print:hidden">
          ...
          <form onSubmit={handleGenerate} className="space-y-4">
            ...
            <div className="mt-4">
              <button type="submit" disabled={loading} className="w-full bg-[#1a73e8] hover:bg-blue-700 text-white font-bold py-3 px-4 rounded transition-all flex items-center justify-center gap-2 cursor-pointer disabled:bg-blue-400 disabled:cursor-wait">
                {loading ? (
                  <>
                    ...
                    <span className="animate-pulse">AIがドラフトを生成中（約1分お待ちください）...</span>
                  </>
                ) : (
                  '様式第13ドラフトを自動生成する'
                )}
